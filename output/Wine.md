...
систем](Поиск_ПО#Какие_существуют_виртуальные_машины_и_среды_для_запуска_других_операционных_систем_\(в_том_числе_MS_Windows%3F\)).
...
программы](Поиск_ПО#Какие_существуют_«эмуляторы»_для_запуска_программ_MS-DOS%2C_MS_Windows_1-3.11%3F).
...
заглянуть в раздел [Games](Games).
