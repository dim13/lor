...
Пакет steam-meta устанавливает все пакеты необходимые для запуска steam:
  ...
  - `steam-client-meta`: мета-пакет, проверяющий наличие все�
...
Распакуйте файл libflashplayer.so. Положите его в один из дву�
...
Но, если Вы не хотите заморачиваться этими делами, то можете скачать и�
